...
public class Vietnam extends JFrame implements Runnable, KeyListener, MouseListener
{
    ...
    public Vietnam()
    {
        ...
        ock = -500;
         ...
         File audioFile = new File("src/aquaponic/water.wav");
        try{
           
//URL url  = this.getClass().getClassLoader().getResource("C:/Users/Leveno/Codes/Java Codes/Aquaponic/src/aquaponic/water.wav");
